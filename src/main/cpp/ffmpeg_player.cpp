...
extern "C"
JNIEXPORT void JNICALL
Java_com_willxing_ffmpegplayer_MainActivity_play(JNIEnv *env, jobject instance, jstring url_,
                                                 jobject surface) {
...
JNIEXPORT void JNICALL
Java_com_willxing_ffmpegplayer_MainActivity_reset(JNIEnv *env, jobject instance) {
